...
import { FaWhatsapp, FaRegClock, FaIdCard, FaAddressCard, FaHome, FaHeart, FaFileInvoice, FaUsers, FaFileAlt} from "react-icons/fa";
  ...
  return (
    <div className="container">
        ...
        <div id="servicoPrevidenciario">  <h1>Serviços e Soluções - PREVIDENCIÁRIO – INSS</h1><br></br><br></br>
          ...
          •	Revisão/ recurso Administrativo. <br></br><br></br>
          <h4>(TODOS ESSES SERVICOS PREVIDENCIARIO SERÁ PRESTADO SOMENTE NO ENDEREÇO DE CONTAGEM)</h4>
      ...
      <div className='buttonWhatsFixo'>
        <a href='https://wa.me/+5531988997860' target='_blank'><FaWhatsapp/></a>
      </div>
